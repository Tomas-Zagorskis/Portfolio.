...
export default function Project({
	...
	return (
		<motion.div
			...
			<section className='bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden rounded-lg sm:pr-8 relative sm:h-[20rem] group-even:pl-8 hover:bg-gray-200 transition'>
